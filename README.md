...
- **`fetch_hrrr_forecast`**: Pings the Open-Meteo REST API using city lat/long to retrieve the hourly GFS+HRRR blended forecast curve (HRRR's rapid hourly updates for US regions).
