        ...
        kwargs.update(
            {
                ...
                "pool_timeout": Config.POSTGRES_POOL_TIMEOUT_SECONDS,
...
async def init_db() -> None:
    ...
    await _run_ddl("ALTER TABLE metar_obs_extended ADD COLUMN IF NOT EXISTS sea_level_pressure_mb FLOAT")
    await _run_ddl("ALTER TABLE metar_obs_extended ADD COLUMN IF NOT EXISTS visibility_sm FLOAT")
    ...
    await _run_ddl("ALTER TABLE metar_obs_extended ADD COLUMN IF NOT EXISTS cloud_base_ft INTEGER")
