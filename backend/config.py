...
class Config:
    ...
    DB_RETENTION_ENABLED: bool = _bool("DB_RETENTION_ENABLED", default=True)
    DB_RETENTION_INTERVAL_SECONDS: int = _int("DB_RETENTION_INTERVAL_SECONDS", 21600)
    DB_RETENTION_MARKET_SNAPSHOT_DAYS: int = _int("DB_RETENTION_MARKET_SNAPSHOT_DAYS", 5)
    DB_RETENTION_MARKET_FLOW_DAYS: int = _int("DB_RETENTION_MARKET_FLOW_DAYS", 7)
    DB_RETENTION_RAW_PAYLOAD_DAYS: int = _int("DB_RETENTION_RAW_PAYLOAD_DAYS", 14)
    DB_RETENTION_SIGNAL_DAYS: int = _int("DB_RETENTION_SIGNAL_DAYS", 45)
    DB_RETENTION_FORECAST_OBS_DAYS: int = _int("DB_RETENTION_FORECAST_OBS_DAYS", 180)
    DB_RETENTION_WALLET_TRADE_DAYS: int = _int("DB_RETENTION_WALLET_TRADE_DAYS", 120)
    DB_RETENTION_WALLET_EXPOSURE_DAYS: int = _int("DB_RETENTION_WALLET_EXPOSURE_DAYS", 45)
    DB_RETENTION_MODEL_INPUT_DAYS: int = _int("DB_RETENTION_MODEL_INPUT_DAYS", 14)
    ...
    EDGE_DECAY_PROTECT_LEADING_BUCKET: bool = _bool("EDGE_DECAY_PROTECT_LEADING_BUCKET", default=True)
    EDGE_DECAY_LEADER_MIN_MODEL_PROB: float = _float("EDGE_DECAY_LEADER_MIN_MODEL_PROB", 0.15)
